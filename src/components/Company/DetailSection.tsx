...
const DetailSection = ({ TikerValue }: DetailSectionProps) => {
      ...
      <Card className="mt-10 w-full">
        {isError && (
          <div className="flex justify-between items-center bg-secondary p-4 text-red-500 rounded-xl">
            <span className="text-sm font-thin">{error.message}</span>
            <span className="text-sm font-thin">
              Wait for 5min to get the response for the api :{")"}
            </span>
          </div>
        )}
        <CardHeader>
                ...
                <Card className="flex-col flex justify-center items-center">
                  <CardHeader>
                    ...
                    <CardDescription className="text-primary">
                      {formatMarketCap(Number(info?.MarketCapitalization))}
                    </CardDescription>
                  </CardHeader>
                </Card>
                <Card className="flex-col flex justify-center items-center">
